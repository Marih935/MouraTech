...
function aniversariantes(mes, Alunos) {
    ...
    for (let i = 0; i < Alunos.length; i++) {
        let data = Alunos[i].nascimento.split('/') //separa a data em dia e mes saida: [dia, mes, ano]
        if (Number(data[1]) === mes) {//se o mes for igual ao mes passado como parametro
            saida.push({data: `${data[0]}/${data[1]}`, nome: Alunos[i].nome})
        }
    }
    //ordenar o array
    saida.sort((a, b) => {
...
console.log(aniversariantes(2, Alunos))